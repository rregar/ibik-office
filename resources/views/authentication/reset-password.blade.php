                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-left">
                                        ...
                                        <p class="mb-4">Silahkan masukan kata sandi baru anda. Password minimal 8 karakter dan memiliki simbol.</p>
                                    </div>
                                    <form method="POST" action="{{ route('forgot-password.update') }}" class="user">
                                        @csrf
